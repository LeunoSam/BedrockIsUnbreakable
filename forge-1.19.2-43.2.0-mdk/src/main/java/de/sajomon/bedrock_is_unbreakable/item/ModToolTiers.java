...
public class ModToolTiers {
    ...
    static {
        OBSIDIAN = TierSortingRegistry.registerTier(
                new ForgeTier(5, 1200, 11f, 4f, 15, ModTags.Blocks.NEEDS_OBSIDIAN_TOOL,
                        () -> Ingredient.of(ModItems.OBSIDIAN_INGOT.get())),
                new ResourceLocation(BedrockIsUnbreakable.MOD_ID, "obsidian"), List.of(Tiers.NETHERITE), List.of());
        ...
        OBSIDIAN_STEEL = TierSortingRegistry.registerTier(
                ...
                new ResourceLocation(BedrockIsUnbreakable.MOD_ID, "obsidian_steel"), List.of(ModToolTiers.OBSIDIAN),
                List.of());
    }
