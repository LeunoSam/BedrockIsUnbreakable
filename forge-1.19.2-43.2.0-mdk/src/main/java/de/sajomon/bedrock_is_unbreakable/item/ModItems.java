...
public class ModItems {
    ...
    public static final RegistryObject<Item> CRYING_OBSIDIAN_INGOT = ITEMS
            .register("crying_obsidian_ingot", () -> new Item(
                    new Item.Properties().tab(ModCreativeModeTab.BEDROCK_IS_UNBREAKABLE_ITEM_TAB)));

    public static final RegistryObject<Item> OBSIDIAN_IRON_ALLOY = ITEMS
            .register("obsidian_iron_alloy", () -> new Item(
                    new Item.Properties().tab(ModCreativeModeTab.BEDROCK_IS_UNBREAKABLE_ITEM_TAB)));
    ...
    // spawn eggs
    public static final RegistryObject<Item> BLUE_SLIME_SPAWN_EGG = ITEMS.register(
