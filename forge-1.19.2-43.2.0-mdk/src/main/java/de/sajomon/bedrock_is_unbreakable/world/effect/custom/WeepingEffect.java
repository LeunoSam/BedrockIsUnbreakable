...
public class WeepingEffect extends MobEffect {
    ...
    private void dropTears(LivingEntity entity) {
        ItemEntity itementity = createItemEntity(entity.getLevel(), entity.getX(), entity.getY(), entity.getZ());
    ...
    private boolean isApplicable(LivingEntity entity) {
        return !entity.getLevel().isClientSide() && !entity.isBaby() && entity.deathTime == 1;
    }
